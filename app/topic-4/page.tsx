...
export default function HomePage() {
  const topics = [
    {
      title: "Tailwind CSS",
      href: "/topic-4/tailwind",
      points: [
      "Utility-First CSS Framework",
      "Responsive Design with Tailwind",
      "Customizing with Config Files",
    ...
    <main>
      ...
      <section className="container mx-auto max-w-5xl px-4 py-8 md:py-12 lg:py-16">
        <div className="flex flex-col gap-4 md:gap-6">
          <h1 className="text-balance text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight">Learn Tailwind CSS</h1>
          <p className="text-muted-foreground max-w-2xl leading-relaxed text-base md:text-lg">
            Clear, hands-on documentation covering core Tailwind CSS concepts — from utility classes and responsive design to theming and component styling.
          </p>
        </div>
      </section>
